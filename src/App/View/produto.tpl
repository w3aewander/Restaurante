...
<div class="container container-produto">
    <div class="jumbotron well-lg">
        <h1 class="text-info">Produtos</h1>
    </div>
    <div class="form-horizontal">
        ...
        <div class="button-group">
            <button  class="btn btn-default glyphicon glyphicon-plus" onclick="novaCategoria();"  title="Criar uma nova categoria"/>
            <button  class="btn btn-default glyphicon glyphicon-check" onclick="salvarCategoria();" title="Salvar categoria existente" />
            <button  class="btn btn-default glyphicon glyphicon-remove" onclick="excluirCategoria();" title="remover categoria" />
        </div>
    </div>
